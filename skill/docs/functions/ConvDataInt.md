...
```lspt
funcao ConvDataInt(alfa end DatAlf, numero end DatNum);
```
...
[Documentação oficial Senior](https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/regra_funcoes/convdataint.htm)
