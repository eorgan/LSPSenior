...
- **Date** (`Numero`) - Entrada: Data que deve ser convertida para alfa
- **Native** (`Numero`) - Entrada: Obsoleto, mantido apenas para compatibilidade
- **DateAlfa** (`Alfa End`) - Saída: Retorno da função com data compatível com SQL nativo
...
[Documentação oficial Senior](https://documentacao.senior.com.br/tecnologia/5.10.4/lsp/funcoes/gerador-de-relatorios/datetodb.htm)
