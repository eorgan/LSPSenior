...
```lspt
Funcao NomeCompletoUsuario (Numero pCodUsu, Alfa End NomUsu);
```
...
[Documentação oficial Senior](https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/regra_funcoes/nomecompletousuario.htm)
