...
```lspt
Funcao (Alfa Remetente, Alfa Assunto, Alfa Destinatario, Alfa CopiaPara, Alfa CopiaOculta, Alfa Corpo, Alfa Anexo, Alfa FormatoMensagem, Alfa End pErro);
```
...
- **pErro** (`Alfa End`) - Saída

## Valores de Retorno

- OK ou não.
- Utilização da Função (dependentes): Nenhum dependente.
- Observação: A formatação HTML no corpo da mensagem
- não é suportada ao utilizar o protocolo MAPI para envio de e-mails.
- <!-- source: https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/regra_funcoes/escondecampotelaentrada.htm -->
...
[Documentação oficial Senior](https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/regra_funcoes/enviaremailex.htm)
