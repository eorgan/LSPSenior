...
```lspt
Funcao ExecutaRelatorioArquivo (Alfa pNomRel, Alfa pTelEnt, Alfa pNomOrd, Alfa pSaidaImpressa, Alfa pNomeArquivo, Alfa pFormatoArquivo);
```
...
[Documentação oficial Senior](https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/regra_funcoes/executa-relatorio-arquivo.htm)
