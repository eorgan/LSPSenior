...
- **pNiv** (`Numero`) - Entrada: Variável numérica que recebe a quantidade de de níveis que a explosão deve buscar (0 - Busca Todos ou 1, 2, 3..99).
...
- **pExc** (`Numero`) - Entrada: Variável com 'S' ou 'N' para trazer ou não o componente exclusivo.
...
[Documentação oficial Senior](https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/regra_funcoes/composicaoproduto_3.htm)
