...
```lspt
Funcao HttpAlteraMostrarProgresso(Alfa Objeto, Numero Mostrar);
```
...
- **Mostrar** (`Numero`) - Entrada: 0 = Não exibir progresso, 1 = Exibir progresso
...
[Documentação oficial Senior](https://documentacao.senior.com.br/tecnologia/5.10.4/lsp/funcoes/requisicoes-http/httpalteramostrarprogresso.htm)
