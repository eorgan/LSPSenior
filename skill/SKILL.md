...
description: >-
  ...
  de nomenclatura, padrões seguros e como consultar o catálogo de 647+ funções built-in
  deste projeto (functions.json + docs/functions/). Inclui as APIs SQL_* e Http*.
---
