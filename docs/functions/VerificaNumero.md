...
```lspt
funcao VerificaNumero(alfa Origem, numero end Retorno);
```
...
[Documentação oficial Senior](https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/regra_funcoes/verificanumero.htm)
