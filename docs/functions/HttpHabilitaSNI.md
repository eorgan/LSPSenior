...
```lspt
Funcao HttpHabilitaSNI(Alfa Objeto);
```
...
[Documentação oficial Senior](https://documentacao.senior.com.br/tecnologia/5.10.4/lsp/funcoes/requisicoes-http/http-habilita-sni.htm)
