...
```lspt
Funcao HttpHabilitarCookies(Alfa end Objeto);
```
...
Habilita o recurso de manter os cookies ao utilizar requisições HTTP em regras LSP.
...
[Documentação oficial Senior](https://documentacao.senior.com.br/tecnologia/5.10.4/lsp/funcoes/requisicoes-http/httphabilitarcookies.htm)
